...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btEntrar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Botoes_5122_accepted_48.png"))); // NOI18N
        btEntrar.setText("Entrar");
        btEntrar.setToolTipText("Entrar no Sistema");
        ...
        bt_sair.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/Botoes_5123_cancel_48.png"))); // NOI18N
        ...
        jButton1.setText("Não consegue acessar o sistema?");
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/15-entropy-256x256.png"))); // NOI18N
        ...
        jmiGF.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_F1, java.awt.event.InputEvent.CTRL_MASK));
        jmiGF.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/People.png"))); // NOI18N
        jmiGF.setText("Gerência de Funcionários");
        jmiGF.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jmiGFActionPerformed(evt);
            }
        });
        jmFuncionarios.add(jmiGF);
        ...
        jmFerramentas.add(jmiBackUp);

        jmiRestaurar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/restaura.png"))); // NOI18N
        jmiRestaurar.setText("Restaurar");
    ...
    public void Logar() {
        if (tf_usuario.getText().isEmpty() || tf_senha.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Necessário preencher todos os campos!!!", "Erro", JOptionPane.INFORMATION_MESSAGE);
        }
        Usuario usuario = new Usuario();
        usuario.setSenha(tf_senha.getText());
        usuario.setUsuario(tf_usuario.getText());
